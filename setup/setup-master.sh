#!/bin/bash
# setup-master.sh — Финальная версия с принудительным сбором метрик и авто-настройкой Kibana
...
# Принудительный scrape для Grafana
...
log "ELK запущен через Docker с авто-настройкой Kibana"
...
echo "=================================================================="
echo "Подожди 30 секунд и обнови Grafana дашборд (F5)."
echo "Если всё ещё N/A — выполни: systemctl restart prometheus prometheus-node-exporter"
echo "=================================================================="
